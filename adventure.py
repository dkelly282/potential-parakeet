...
def diamond_room():
    print(f"\n{name} you cannot believe your luck.  \nYou now find yourself in a  small room that is filled with a large mound of diamonds.")
    ...
    if answer == "1":
        ...
        game_over(f" Bad luck {name}. The moment you moved the diamonds, you triggered a hidden lever and set off a massive tremor that made the tunnel collapse. \nYour lifeless corpse will lie there for eternity")
    elif answer == "2":
...
def monster_room():
    ...
    print("However, luck is on your side and the ogre is asleep.\nBehind the ogre, there is another door. \nWhat shall you do? (1 or 2)")
    ...
    if answer == "1":
        ...
        game_over("Your puny penknife merely tickles the ogre and makes him swing his arm round to scratch the itch. \nHis huge clublike hand crushes your skull and the ogre carries on snoring unaware that a tasty little snack now lies next to him.")
    else:
        wrong_number()
        
def bear_room():
  
    print("\nYou push open the door to find a giant bear standing there. \nYou have startled him and only have a few seconds to choose your next move before the bear reacts to your presence.")
    ...
    if answer == "1":
        game_over("Are you really that stupid? \nThe bear loves his honey and with one sweep of his giant paw kills you.")
    elif answer == "2":
        print("\nGood choice! \nThe bear is sensitive about his weight and your cruel taunts made him run away and hide in his bed. \nYou can now go through the door behind him!")
        final_door()
def final_door():
        print("Please type 'e' to enter the next room")
        answer = input(">")
        if answer == "e":
            diamond_room()
        else:
